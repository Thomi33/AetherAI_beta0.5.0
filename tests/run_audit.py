...
print(f"  GUI launcher regex pattern: {_LANZADORES_GUI.pattern}")
...
print(f"  Filesystem - write_file permission: {fs_perm}")
print(f"  GitHub - create_issue permission: {github_issue_perm}")
